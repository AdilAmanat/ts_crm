                ...
                <div class="col-12">
                	<form class="card" id="add_handset_type_form" enctype="multipart/form-data" method="post">
                    	<div class="card-header">
                        	<h3 class="card-title"><?php echo $mode;?> Handset Type</h3>
                        </div>
                        <div class="card-body">
                            <div class="col-md-12">
                        ...
                        <div class="card-footer text-right">
                          <div class="d-flex">
                            <button type="submit" class="btn btn-primary ml-auto add_handset_type_submit" id="add_handset_type_submit"><?php echo $mode;?> Handset Type</button>
                          </div>
                        </div>                        
                    </form>
