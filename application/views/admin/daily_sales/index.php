      ...
      <div class="page-main">
        ...
        <div class="col-12" id="filter-div">
            ...
            <div class="card-header">
                ...
                <a href="/admin/daily-sales/add/" class="btn btn-primary ml-auto">Add Daily Sales</a>
            </div>
                <div class="card-body">
                	<div class="row">
                        ...
                        <?php if(count($sales) > 0 ){?>
						  ...
						  foreach($sales as $key => $sale){?>
                            <tr>
                              ...
                              <td><?php echo $sale['locaiton_name'];?></td>
                              <td><?php echo $sale['package_name'];?></td>
                              <td><?php echo $sale['package_duration'];?></td>
                              <td><?php echo $sale['sim_serial_no'];?></td>
                              <td><?php echo $sale['directory_no'];?></td>
                              <td><?php echo $sale['city_name'];?></td>
                              <td><?php echo $sale['classifications_name'];?></td>
                              <td><?php echo $sale['promo_device_name'];?></td>
                              <td><?php echo $sale['acquistion'];?></td>
                              <td><?php echo ucfirst($sale['acquistion_agent_first_name']) . " " . ucfirst($sale['acquistion_agent_last_name']);?></td>
                              <td><a href="/admin/daily-sales/view/<?php echo $sale['id'];?>" class="icon"><i class="fe fe-eye"></i></a></td>
                              <td><a href="/admin/daily-sales/edit/<?php echo $sale['id'];?>" class="icon"><i class="fe fe-edit"></i></a></td>
