...
<body>
<ul class="top-menu">
	<li style="float:left;padding:10px;">Teamlead Panel</li>
  <li><a href="/users/logout/">Logout</a></li>
  <?php /*?><li><a href="/teamlead/generate-numbers">Generate Numbers</a></li><?php */?>
  <li><a href="/teamlead/team-members/">Team Members</a></li>
  <li><a href="/teamlead/">Home</a></li>
