              ...
              <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 col-xl-12">
                        ...
                        <div class="col-md-3 col-lg-3">
                            <div class="form-group">
                                <?php echo form_label('Assign to TL Agent', 'tl_agent', array('class' => 'form-label'));?>
                                <select name="tl_agent" id="tl_agent" class="form-control custom-select">
                                    <option value="">Please Select</option>
                                    <?php
									foreach($csrs as $csr){
										$sel = "";
										if(isset($filters["tl_agent"]) && $filters["tl_agent"] == $csr["id"]){
											$sel = " selected='selected'";
										}
									?>
...
$(document).ready(function(){
	$(".assign_back").click(function(){
		if($.trim($("#comment").val()) == ""){
			...
			$.ajax({
				type: "POST",
				url: "/teamlead-csr/assign-number",
				data: {
					"id" : number_id,
					"assign_to" : assign_to,
				...
				success: function(msg){
					...
					window.location = "/teamlead-csr/tlagent-update/";
	...
	$("#team_members, #tl_agent").change(function(){
		if($(this).val() != ""){
			if($.trim($("#comment").val()) == ""){
				$(this).val("");
				alert("Please enter comment.");
