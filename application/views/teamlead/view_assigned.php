                        ...
                        <?php if(count($numbers) > 0 ){?>
                          ...
                          <?php
							...
							echo "<tr>";
                                ...
                                <?php if($assgined_by == "tsa"){?>
                                <td><?php echo $number["status_name"];?></td>
                                <?php }?>
                                <td><a href="/teamlead-agent/view-assigned-detail/<?php echo $number["number_id"]."/".$number["id"];?>/" class="update-btn">View</a></td>
                                <?php
							echo "</tr>";
						   }?>
