                	...
                	<div class="row">
                        <div class="col-md-3 col-lg-3">
                            <div class="form-group">
                                ...
                                <input type="text" id="series_start" name="series_start" placeholder="Series start" value="<?php echo (isset($filters["series_start"]) && $filters["series_start"] != "")?$filters["series_start"]:"";?>"/>
                            </div>
                        </div>
                        <div class="col-md-3 col-lg-3">
                            <div class="form-group">
                                <?php echo form_label('Series End', 'series_end', array('class' => 'form-label'));?>
                                <input type="text" id="series_end" name="series_end" placeholder="Series end" value="<?php echo (isset($filters["series_end"]) && $filters["series_end"] != "")?$filters["series_end"]:"";?>"/>
                            </div>
                        </div>
                        <div class="col-md-3 col-lg-3">
                            <div class="form-group">
                                <?php echo form_label('Emirates ID', 'emirates_id', array('class' => 'form-label'));?>
                                <input type="text" id="emirates_id" name="emirates_id" placeholder="Emirates ID" value="<?php echo (isset($filters["emirates_id"]) && $filters["emirates_id"] != "")?$filters["emirates_id"]:"";?>"/>
                            </div>
                        </div>
                        <div class="col-md-3 col-lg-3">
                            <div class="form-group">
                        ...
                        <div class="col-md-3 col-lg-3">
                            <div class="form-group">
                               ...
                               <input type="text" id="activation_date_from" name="activation_date_from" placeholder="Activation Date From" value="<?php echo (isset($filters["activation_date_from"]) && $filters["activation_date_from"] != "")?$filters["activation_date_from"]:"";?>"/>
                            </div>
                        </div>
                        <div class="col-md-3 col-lg-3">
                            <div class="form-group">
                                <?php echo form_label('Activation Date Till', 'activation_date_till', array('class' => 'form-label'));?>
                               <input type="text" id="activation_date_till" name="activation_date_till" placeholder="Activation Date Till" value="<?php echo (isset($filters["activation_date_till"]) && $filters["activation_date_till"] != "")?$filters["activation_date_till"]:"";?>"/>
                            </div>
                        </div>
                        <div class="col-md-3 col-lg-3">
                            <div class="form-group">
                        ...
                        <div class="col-md-3 col-lg-3">
                            <div class="form-group">
                                ...
                                <input type="text" id="total_no" name="total_no" placeholder="Total Numbers" value="<?php echo (isset($filters["total_no"]) && $filters["total_no"] != "")?$filters["total_no"]:"";?>"/>
                            </div>
                        </div>
                    </div>
                </div>
