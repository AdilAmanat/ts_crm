...
$(document).ready(function(){
	$("#add_handset_type_submit").on("click", function(e){
		//return true;
		e.preventDefault();
		$("#add_handset_type_form .formError").remove();
		...
		if(name == ""){
			$(errorElementStart + "Please enter handset name."+errorElementEnd).insertAfter($("#name"));
			errorCount++;
		}
				
		if(errorCount == 0){
			$("#add_handset_type_form").submit();
		}
		else{
			return false;
		}
